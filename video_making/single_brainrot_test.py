#!/usr/bin/env python3
"""
Single Brainrot Integral Test
Creates a video with the new brainrot integral dialogue
"""
...
def create_brainrot_integral_video():
    base_dir = Path(__file__).parent
    ...
    print("🧠 Creating Brainrot Integral Video")
    ...
    # Load dialogue
    dialogue_path = inputs_dir / "dialogues" / "integrals_area.json"
    ...
    print(f"  📝 Loaded {len(dialogue)} brainrot dialogue lines")
    ...
    # Use minecraft background
    background_video = str(assets_dir / "backgrounds" / "minecraft_1.mp4")
    ...
    # Output path
    output_path = outputs_dir / "brainrot_integrals_test.mp4"
    print(f"  💾 Creating brainrot video: {output_path}")
    ...
    print(f"  ✅ Brainrot integral video created: {output_path}")
    return str(output_path)


if __name__ == "__main__":
    create_brainrot_integral_video()